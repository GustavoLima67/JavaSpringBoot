...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2022-1-27T15:49:01Z"), OrderStatus.PAID,u1);
		Order o2 = new Order(null, Instant.parse("2022-2-28T03:42:10Z"), OrderStatus.WATING_PAYMENT,u2);
		Order o3 = new Order(null, Instant.parse("2022-3-29T21:21:32Z"), OrderStatus.WATING_PAYMENT,u1);
		...
		Payment pay1 = new Payment(null, Instant.parse("2022-1-27T21:49:01Z"), o1);
		o1.setPayment(pay1);
